...
class SettingsScreen(ctk.CTkFrame):
    def __init__(self, parent, controller):
        ...
        curr_pw_row = ctk.CTkFrame(self, fg_color="transparent")
        curr_pw_row.grid(row=9, column=1, pady=(0, 16))

        self.curr_pw_entry = ctk.CTkEntry(
            curr_pw_row,
            width=520, height=50,
        ...
        self.curr_pw_entry.grid(row=0, column=0)

        self.curr_pw_show_btn = ctk.CTkButton(
            curr_pw_row,
            text="Show",
            width=70, height=50,
            font=("Helvetica", 13),
            fg_color="transparent",
            border_width=1,
            command=lambda: self._toggle_entry(self.curr_pw_entry, self.curr_pw_show_btn)
        )
        self.curr_pw_show_btn.grid(row=0, column=1, padx=(8, 0))
        ...
        new_pw_row = ctk.CTkFrame(self, fg_color="transparent")
        new_pw_row.grid(row=11, column=1, pady=(0, 6))
        ...
        self.new_pw_entry.grid(row=0, column=0)

        self.new_pw_show_btn = ctk.CTkButton(
            new_pw_row,
            text="Show",
            width=70, height=50,
            font=("Helvetica", 13),
            fg_color="transparent",
            border_width=1,
            command=lambda: self._toggle_entry(self.new_pw_entry, self.new_pw_show_btn)
        )
        self.new_pw_show_btn.grid(row=0, column=1, padx=(8, 0))
        ...
        confirm_pw_row = ctk.CTkFrame(self, fg_color="transparent")
        confirm_pw_row.grid(row=14, column=1, pady=(0, 12))
        ...
        self.confirm_pw_entry.grid(row=0, column=0)

        self.confirm_pw_show_btn = ctk.CTkButton(
            confirm_pw_row,
            text="Show",
            width=70, height=50,
            font=("Helvetica", 13),
            fg_color="transparent",
            border_width=1,
            command=lambda: self._toggle_entry(self.confirm_pw_entry, self.confirm_pw_show_btn)
        )
        self.confirm_pw_show_btn.grid(row=0, column=1, padx=(8, 0))
    ...
    def _change_password(self):
        current = self.curr_pw_entry.get()
        ...
        self.curr_pw_entry.delete(0, "end")
